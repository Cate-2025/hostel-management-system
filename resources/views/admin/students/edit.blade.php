                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('students.update', $student) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="enrollment_number" id="enrollment_number" value="{{ old('enrollment_number', $student->enrollment_number) }}" 
                        ...
                        <div class="mb-4">
                            ...
                            <input type="tel" name="contact_number" id="contact_number" value="{{ old('contact_number', $student->contact_number) }}" 
                        ...
                        <div class="mb-4">
                            ...
                            <input type="tel" name="parent_contact" id="parent_contact" value="{{ old('parent_contact', $student->parent_contact) }}" 
                                class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500">
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="address" id="address" rows="3" 
                                class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500">{{ old('address', $student->address) }}</textarea>
                        </div>
